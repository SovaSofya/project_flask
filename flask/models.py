...
#  I want to declare any functions that would be useful in the app here, so they wouldn't
#  meddle with the main code. Following functions may partially be the same as in the
#  prework.ipynb, because they include functons, created for W2V model, that I used before to
#  process initial data.

modelmine = gensim.models.KeyedVectors.load_word2vec_format("ruscorpora_upos_skipgram_300_5_2018.vec.gz", binary=False)


#  following code is function for lemmatizing any text and making Universal POS Tags for it
#  I took the code from here: https://github.com/akutuzov/webvectors/blob/master/preprocessing/rus_preprocessing_udpipe.py
#  and here: https://notebook.community/akutuzov/webvectors/preprocessing/rusvectores_tutorial
#  I've marked these links in prework.ipynb as well
...
#  and this is my own function, that embodies preparing the string, vectorizing it and
#  finding the mean vector for the input
